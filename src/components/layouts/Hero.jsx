      ...
      <div className="bg-[url('/src/assets/hero.jpg')] bg-no-repeat bg-cover bg-center py-[200px]">
        <Container>
          <div className="w-[686px]">
            ...
            <p className="w-[550px] text-[#6C7D93] text-xl font-paprika leading-[36px] py-5">Use customer data to build great and solid product experiences that convert. Digital marketing’s development has changed the way brands and businesses use technology for marketing. </p>
